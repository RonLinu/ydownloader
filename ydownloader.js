...
(function() {
  var askConfirm, getVideoFolder, languages, resolutions, showAlert, socket;
...
\u00A9 2025 - RonLinu`;
  ...
  document.getElementById('dependencies').onclick = async function() {
    var failCross, gather_results, goodCheck, howmany, plural, result, results;
    results = '';
    failCross = '&#x2718;';
    goodCheck = '&#x2714;';
    ...
    if (results.indexOf(failCross) === -1) {
      ...
      plural = howmany > 1 ? 'dependencies are' : 'dependency is';
  ...
  document.getElementById('download').onclick = function() {
    ...
    return socket.exec(final_cmd, 0); // 0 = no timeout to download videos
  };
