...
var askConfirm, changeVideoFolder, getOS, languages, msg, openVideoFolderFlag, resolutions, showAlert, socket, socket_send, timedAlert;
...
(function() {
  ...
  return socket.onmessage = function(event) {
    if (event.data.indexOf('Error') > -1) {
      return showAlert('', 'error', event.data);
    }
  };
})();
