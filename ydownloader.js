// Generated by CoffeeScript 2.7.0
  // ********************** WEBSOCKET HANDLER ****************************
var askConfirm, getVideoFolder, languages, resolutions, showAlert, socket, socketHandler,
  indexOf = [].indexOf;

socketHandler = function() {
  var os, platform, port, quit, receive, ref, send, serverReply, socket;
  ...
  if ((ref = parseInt('0' + port), indexOf.call([8080, 8081, 8082, 8083, 8084, 8085, 8086, 8087, 8088, 8089], ref) < 0) || (os !== 'win32' && os !== 'linux' && os !== 'darwin')) {
  ...
  return {send, receive, quit, platform};
};
...
document.getElementById('download').onclick = function() {
  ...
  return socket.send('run', final_cmd);
};
