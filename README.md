...
This information is the web socket port number, a security session identifier and the user platform,  
...
- copy the "websocket" directory provided here on the user machine
