...
(function() {
  ...
  */
  ...
  window.serverHandler = function() {
    var exec, fragment, platform, read, ref, script, send, serverPlatform, serverReply, serverVersion, socket, socketPort, update, version;
    ...
    return {version, platform, update, exec, script, send, read};
  };
